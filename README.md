...
If you just want to use the program you only need the file **sympad.py** - along with the SymPy Python package installed on your system of course: [https://sympy.org/](https://sympy.org/).
