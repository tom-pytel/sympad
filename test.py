...
def ast2simple2ast (ast):
	return sparser (ast2simple (ast))
...
class Test (unittest.TestCase):
	...
	def test_ast2simple (self):
		...
		self.assertEqual (ast2simple (p ('xy')), 'xy')
		self.assertEqual (ast2simple (p ('x(y)')), 'x(y)')
		self.assertEqual (ast2simple (p ('x/y')), 'x/y')
		self.assertEqual (ast2simple (p ('x^y')), 'x**y')
		self.assertEqual (ast2simple (p ('log x')), 'ln(x)')
		self.assertEqual (ast2simple (p ('log {x}')), 'ln(x)')
		self.assertEqual (ast2simple (p ('log (x)')), 'ln(x)')
		...
		self.assertEqual (ast2simple (p ('\\lim_{x\\to0^+} 1/x')), '\\lim_{x \\to 0**+} 1/x')
		self.assertEqual (ast2simple (p ('\\lim_{x\\to0**-} 1/x')), '\\lim_{x \\to 0**-} 1/x')
		self.assertEqual (ast2simple (p ('Limit (1/x, x, 0)')), '\\lim_{x \\to 0**+} 1/x')
		self.assertEqual (ast2simple (p ('Limit (1/x, x, 0, "-")')), '\\lim_{x \\to 0**-} 1/x')
		self.assertEqual (ast2simple (p ('Limit (1/x, x, 0, dir="+-")')), '\\lim_{x \\to 0} 1/x')
		self.assertEqual (ast2simple (p ('\\sum_{n=0}^\\infty x^n/n!')), '\\sum_{n=0}^oo x**n / n!')
		self.assertEqual (ast2simple (p ('Sum (x^n/n!, (n, 0, oo))')), '\\sum_{n=0}^oo x**n / n!')
		...
		self.assertEqual (ast2simple (p ('Derivative (x^2y**2z, x, 2, y, z)')), 'd^4/dx**2dydz(x**2y**2z)')
		...
		self.assertEqual (ast2simple (p ('Integral (\\int y dy, (x, 0, 1))')), '\\int_0^1 \\int y dy dx')
		self.assertEqual (ast2simple (p ('{1,}')), '{1,}')
		...
		self.assertEqual (ast2simple (p ('\\begin{bmatrix} 1 \\\\ \\end{bmatrix}')), '{{1,},}')
		...
		self.assertEqual (ast2simple (p ('\\begin{matrix} 1 & 2 \\\\ 3 & 4 \\\\ \\end{matrix}')), '{{1,2},{3,4}}')
		...
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.T')), '{{1,2,3},{4,5,6}}.T')
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.T.T')), '{{1,2,3},{4,5,6}}.T.T')
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.T.T.T')), '{{1,2,3},{4,5,6}}.T.T.T')
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.transpose ()')), '{{1,2,3},{4,5,6}}.transpose()')
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.transpose ().transpose ()')), '{{1,2,3},{4,5,6}}.transpose().transpose()')
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.transpose ().transpose ().transpose ()')), '{{1,2,3},{4,5,6}}.transpose().transpose().transpose()')
		self.assertEqual (ast2simple (p ('{{1,2,3},{4,5,6}}.transpose ().transpose ().T.T.transpose ().transpose ()')), '{{1,2,3},{4,5,6}}.transpose().transpose().T.T.transpose().transpose()')
		self.assertEqual (ast2simple (p ('\\begin{matrix} A & B \\\\ C & D \\end{matrix} * {x, y}')), '{{A,B},{C,D}} {x,y}')
	...
	def test_ast2simple2ast (self):
		self.assertEqual (ast2simple2ast (p ('1')), ('#', '1'))
		self.assertEqual (ast2simple2ast (p ('-1.23456789012345678901234567890123456789012345678901234567890123456789012345678901')), ('#', '-1.23456789012345678901234567890123456789012345678901234567890123456789012345678901'))
		self.assertEqual (ast2simple2ast (p ('x')), ('@', 'x'))
		self.assertEqual (ast2simple2ast (p ('-1')), ('#', '-1'))
		self.assertEqual (ast2simple2ast (p ('-x')), ('-', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('{x}')), ('@', 'x'))
		self.assertEqual (ast2simple2ast (p ('{{x}}')), ('@', 'x'))
		self.assertEqual (ast2simple2ast (p ('()')), ('(', (',', ())))
		self.assertEqual (ast2simple2ast (p ('(x)')), ('(', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('(x,)')), ('(', (',', (('@', 'x'),))))
		self.assertEqual (ast2simple2ast (p ('(x,y)')), ('(', (',', (('@', 'x'), ('@', 'y')))))
		self.assertEqual (ast2simple2ast (p ('(x,y,)')), ('(', (',', (('@', 'x'), ('@', 'y')))))
		self.assertEqual (ast2simple2ast (p ('[]')), ('[', ()))
		self.assertEqual (ast2simple2ast (p ('[x]')), ('[', (('@', 'x'),)))
		self.assertEqual (ast2simple2ast (p ('[x,]')), ('[', (('@', 'x'),)))
		self.assertEqual (ast2simple2ast (p ('[x,y]')), ('[', (('@', 'x'), ('@', 'y'))))
		self.assertEqual (ast2simple2ast (p ('[x,y,]')), ('[', (('@', 'x'), ('@', 'y'))))
		self.assertEqual (ast2simple2ast (p ('"x\\x20\\n"')), ('"', 'x \n'))
		self.assertEqual (ast2simple2ast (p ("'x\\x20\\n'")), ('"', 'x \n'))
		self.assertEqual (ast2simple2ast (p ('|x|')), ('|', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('x!')), ('!', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('x+y')), ('+', (('@', 'x'), ('@', 'y'))))
		self.assertEqual (ast2simple2ast (p ('x-y')), ('+', (('@', 'x'), ('-', ('@', 'y')))))
		self.assertEqual (ast2simple2ast (p ('x*y')), ('*', (('@', 'x'), ('@', 'y'))))
		self.assertEqual (ast2simple2ast (p ('xy')), ('*', (('@', 'x'), ('@', 'y'))))
		self.assertEqual (ast2simple2ast (p ('x(y)')), ('*', (('@', 'x'), ('(', ('@', 'y')))))
		self.assertEqual (ast2simple2ast (p ('x/y')), ('/', ('@', 'x'), ('@', 'y')))
		self.assertEqual (ast2simple2ast (p ('x^y')), ('^', ('@', 'x'), ('@', 'y')))
		self.assertEqual (ast2simple2ast (p ('log x')), ('log', ('(', ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('log {x}')), ('log', ('(', ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('log (x)')), ('log', ('(', ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('log_2 x')), ('log', ('(', ('@', 'x')), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('log_2 {x}')), ('log', ('(', ('@', 'x')), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('log_2 (x)')), ('log', ('(', ('@', 'x')), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('sqrt x')), ('sqrt', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('sqrt {x}')), ('sqrt', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('sqrt (x)')), ('sqrt', ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('sqrt[3] x')), ('sqrt', ('@', 'x'), ('#', '3')))
		self.assertEqual (ast2simple2ast (p ('sqrt[3] {x}')), ('sqrt', ('@', 'x'), ('#', '3')))
		self.assertEqual (ast2simple2ast (p ('sqrt[3] (x)')), ('sqrt', ('@', 'x'), ('#', '3')))
		self.assertEqual (ast2simple2ast (p ('sin x')), ('func', 'sin', ('(', ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('sin^2 x')), ('^', ('func', 'sin', ('(', ('@', 'x'))), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('sin (x)')), ('func', 'sin', ('(', ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('sin (x)^2')), ('^', ('func', 'sin', ('(', ('@', 'x'))), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('{sin x}^2')), ('^', ('func', 'sin', ('(', ('@', 'x'))), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('sin**2 x')), ('^', ('func', 'sin', ('(', ('@', 'x'))), ('#', '2')))
		self.assertEqual (ast2simple2ast (p ('sin**-1 x')), ('func', 'asin', ('(', ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('\\lim_{x\\to0} 1/x')), ('lim', ('/', ('#', '1'), ('@', 'x')), ('@', 'x'), ('#', '0')))
		self.assertEqual (ast2simple2ast (p ('\\lim_{x\\to0^+} 1/x')), ('lim', ('/', ('#', '1'), ('@', 'x')), ('@', 'x'), ('#', '0'), '+'))
		self.assertEqual (ast2simple2ast (p ('\\lim_{x\\to0**-} 1/x')), ('lim', ('/', ('#', '1'), ('@', 'x')), ('@', 'x'), ('#', '0'), '-'))
		self.assertEqual (ast2simple2ast (p ('Limit (1/x, x, 0)')), ('lim', ('/', ('#', '1'), ('@', 'x')), ('@', 'x'), ('#', '0'), '+'))
		self.assertEqual (ast2simple2ast (p ('Limit (1/x, x, 0, "-")')), ('lim', ('/', ('#', '1'), ('@', 'x')), ('@', 'x'), ('#', '0'), '-'))
		self.assertEqual (ast2simple2ast (p ('Limit (1/x, x, 0, dir="+-")')), ('lim', ('/', ('#', '1'), ('@', 'x')), ('@', 'x'), ('#', '0')))
		self.assertEqual (ast2simple2ast (p ('\\sum_{n=0}^\\infty x^n/n!')), ('sum', ('/', ('^', ('@', 'x'), ('@', 'n')), ('!', ('@', 'n'))), ('@', 'n'), ('#', '0'), ('@', '\\infty')))
		self.assertEqual (ast2simple2ast (p ('Sum (x^n/n!, (n, 0, oo))')), ('sum', ('/', ('^', ('@', 'x'), ('@', 'n')), ('!', ('@', 'n'))), ('@', 'n'), ('#', '0'), ('@', '\\infty')))
		self.assertEqual (ast2simple2ast (p ('d/dx x**2y**2z')), ('diff', ('(', ('*', (('^', ('@', 'x'), ('#', '2')), ('^', ('@', 'y'), ('#', '2')), ('@', 'z')))), (('@', 'dx'),)))
		self.assertEqual (ast2simple2ast (p ('d^2/dx^2 x^2y**2z')), ('diff', ('(', ('*', (('^', ('@', 'x'), ('#', '2')), ('^', ('@', 'y'), ('#', '2')), ('@', 'z')))), (('^', ('@', 'dx'), ('#', '2')),)))
		self.assertEqual (ast2simple2ast (p ('d^3/dx^2dy x^2y**2z')), ('diff', ('(', ('*', (('^', ('@', 'x'), ('#', '2')), ('^', ('@', 'y'), ('#', '2')), ('@', 'z')))), (('^', ('@', 'dx'), ('#', '2')), ('@', 'dy'))))
		self.assertEqual (ast2simple2ast (p ('\\partial^4/\\partialx^2\\partial y\\partialz x^2y**2z')), ('diff', ('(', ('*', (('^', ('@', 'x'), ('#', '2')), ('^', ('@', 'y'), ('#', '2')), ('@', 'z')))), (('^', ('@', '\\partial x'), ('#', '2')), ('@', '\\partial y'), ('@', '\\partial z'))))
		self.assertEqual (ast2simple2ast (p ('Derivative (x^2y**2z, x, 2, y, z)')), ('diff', ('(', ('*', (('^', ('@', 'x'), ('#', '2')), ('^', ('@', 'y'), ('#', '2')), ('@', 'z')))), (('^', ('@', 'dx'), ('#', '2')), ('@', 'dy'), ('@', 'dz'))))
		self.assertEqual (ast2simple2ast (p ('\\int dx')), ('intg', None, ('@', 'dx')))
		self.assertEqual (ast2simple2ast (p ('\\int x dx')), ('intg', ('@', 'x'), ('@', 'dx')))
		self.assertEqual (ast2simple2ast (p ('\\int_0^1 x dx')), ('intg', ('@', 'x'), ('@', 'dx'), ('#', '0'), ('#', '1')))
		self.assertEqual (ast2simple2ast (p ('\\int_0^1 \\int y dy dx')), ('intg', ('intg', ('@', 'y'), ('@', 'dy')), ('@', 'dx'), ('#', '0'), ('#', '1')))
		self.assertEqual (ast2simple2ast (p ('Integral (\\int y dy, (x, 0, 1))')), ('intg', ('intg', ('@', 'y'), ('@', 'dy')), ('@', 'dx'), ('#', '0'), ('#', '1')))
		self.assertEqual (ast2simple2ast (p ('{1,}')), ('vec', (('#', '1'),)))
		self.assertEqual (ast2simple2ast (p ('{1,2}')), ('vec', (('#', '1'), ('#', '2'))))
		self.assertEqual (ast2simple2ast (p ('{1,2,}')), ('vec', (('#', '1'), ('#', '2'))))
		self.assertEqual (ast2simple2ast (p ('{{1,},}')), ('mat', ((('#', '1'),),)))
		self.assertEqual (ast2simple2ast (p ('{{1,},{2,}}')), ('mat', ((('#', '1'),), (('#', '2'),))))
		self.assertEqual (ast2simple2ast (p ('{{1,},{2,},}')), ('mat', ((('#', '1'),), (('#', '2'),))))
		self.assertEqual (ast2simple2ast (p ('\\left[\\begin{matrix} 1 \\end{matrix}\\right]')), ('mat', ((('#', '1'),),)))
		self.assertEqual (ast2simple2ast (p ('\\begin{bmatrix} 1 \\\\ \\end{bmatrix}')), ('mat', ((('#', '1'),),)))
		self.assertEqual (ast2simple2ast (p ('\\begin{vmatrix} 1 & 2 \\\\ \\end{vmatrix}')), ('mat', ((('#', '1'), ('#', '2')),)))
		self.assertEqual (ast2simple2ast (p ('\\begin{pmatrix} 1 & 2 \\\\ 3 & 4 \\end{pmatrix}')), ('mat', ((('#', '1'), ('#', '2')), (('#', '3'), ('#', '4')))))
		self.assertEqual (ast2simple2ast (p ('\\begin{matrix} 1 & 2 \\\\ 3 & 4 \\\\ \\end{matrix}')), ('mat', ((('#', '1'), ('#', '2')), (('#', '3'), ('#', '4')))))
		self.assertEqual (ast2simple2ast (p ('-1**x')), ('-', ('^', ('#', '1'), ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('{-1}**x')), ('^', ('(', ('#', '-1')), ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('-{-1}**x')), ('-', ('^', ('(', ('#', '-1')), ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('(-1)**x')), ('^', ('(', ('#', '-1')), ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('-(-1)**x')), ('-', ('^', ('(', ('#', '-1')), ('@', 'x'))))
		self.assertEqual (ast2simple2ast (p ('{1,2}!')), ('!', ('vec', (('#', '1'), ('#', '2')))))
		self.assertEqual (ast2simple2ast (p ('{{0,1},{1,0}}**x')), ('^', ('mat', ((('#', '0'), ('#', '1')), (('#', '1'), ('#', '0')))), ('@', 'x')))
		self.assertEqual (ast2simple2ast (p ('{{1,2},{3,4}}!')), ('!', ('mat', ((('#', '1'), ('#', '2')), (('#', '3'), ('#', '4'))))))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.T')), ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'T'))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.T.T')), ('.', ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'T'), 'T'))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.T.T.T')), ('.', ('.', ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'T'), 'T'), 'T'))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.transpose ()')), ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'transpose', (',', ())))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.transpose ().transpose ()')), ('.', ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'transpose', (',', ())), 'transpose', (',', ())))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.transpose ().transpose ().transpose ()')), ('.', ('.', ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'transpose', (',', ())), 'transpose', (',', ())), 'transpose', (',', ())))
		self.assertEqual (ast2simple2ast (p ('{{1,2,3},{4,5,6}}.transpose ().transpose ().T.T.transpose ().transpose ()')), ('.', ('.', ('.', ('.', ('.', ('.', ('mat', ((('#', '1'), ('#', '2'), ('#', '3')), (('#', '4'), ('#', '5'), ('#', '6')))), 'transpose', (',', ())), 'transpose', (',', ())), 'T'), 'T'), 'transpose', (',', ())), 'transpose', (',', ())))
		self.assertEqual (ast2simple2ast (p ('\\begin{matrix} A & B \\\\ C & D \\end{matrix} * {x, y}')), ('*', (('mat', ((('@', 'A'), ('@', 'B')), (('@', 'C'), ('@', 'D')))), ('vec', (('@', 'x'), ('@', 'y'))))))
		self.assertEqual (ast2simple2ast (p ('\\Theta \\Lambda \\xi \\Omega \\alpha \\theta \\Phi \\gamma \\nu \\Gamma \\delta \\rho \\lambda \\iota \\chi \\psi \\Psi \\Xi \\tau \\mu \\sigma \\omega \\kappa \\upsilon \\eta \\Pi \\epsilon \\Delta \\Upsilon \\zeta \\beta \\phi \\Sigma')), ('*', (('@', '\\Theta'), ('@', '\\Lambda'), ('@', '\\xi'), ('@', '\\Omega'), ('@', '\\alpha'), ('@', '\\theta'), ('@', '\\Phi'), ('@', '\\gamma'), ('@', '\\nu'), ('@', '\\Gamma'), ('@', '\\delta'), ('@', '\\rho'), ('@', '\\lambda'), ('@', '\\iota'), ('@', '\\chi'), ('@', '\\psi'), ('@', '\\Psi'), ('@', '\\Xi'), ('@', '\\tau'), ('@', '\\mu'), ('@', '\\sigma'), ('@', '\\omega'), ('@', '\\kappa'), ('@', '\\upsilon'), ('@', '\\eta'), ('@', '\\Pi'), ('@', '\\epsilon'), ('@', '\\Delta'), ('@', '\\Upsilon'), ('@', '\\zeta'), ('@', '\\beta'), ('@', '\\phi'), ('@', '\\Sigma'))))
...
if __name__ == '__main__':
	...
	if len (sys.argv) == 1:
		...
		for func in (sparser, ast2tex, ast2simple, ast2py, ast2tex2ast, ast2simple2ast, ast2py2ast, ast2spt2ast):
			print ()
